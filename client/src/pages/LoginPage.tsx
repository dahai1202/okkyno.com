          ...
          <CardContent>
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value="login">
                ...
                <div className="mt-4 mb-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-lg">👤</span>
                    <h4 className="font-semibold text-blue-800">Admin Access</h4>
                  </div>
                  <div className="text-sm text-blue-700 space-y-1">
                    <p><strong>Username:</strong> <code className="bg-white px-2 py-0.5 rounded">admin</code></p>
                    <p><strong>Password:</strong> <code className="bg-white px-2 py-0.5 rounded">admin123</code></p>
                  </div>
